        ...
        return(
            <>
                ...
                <main className='corpoCursos'>
                    <h1>Cursos</h1>
                    <p className='SubtituloCursos'>
                        O GAGÁ INSANO traz uma série de cursos completíssimos, 
                        que abrangem desde a base até o aprofundamento!
                        Produzimos o conteúdo com o objetivo de evoluir o 
                        aluno até o nível da prova de seu desejo, a fim de que 
                        esteja preparado, traquilo e confiante para qualquer que 
                        seja o desafio. 
                    </p>
                    <ul>
                        <li>
